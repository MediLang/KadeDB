...
int main() {
  ...
  assert(KadeDB_ValidateUniqueRows(simple_cols, 4, rows_ignore, 2, 1, buf, sizeof(buf)) == 1);
  assert(KadeDB_ValidateUniqueRows(simple_cols, 4, rows_ignore, 2, 0, buf, sizeof(buf)) == 0);
