...
int main() {
  ...
  assert(ds);
  assert(KadeDB_DocumentSchema_AddField(ds, "status", KDB_COL_STRING, 0, 0) ==
         1);
  ...
  // Flip flags: make id non-nullable and non-unique, then null duplicates
  // allowed but null invalid
